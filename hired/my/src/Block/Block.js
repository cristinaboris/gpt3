...
const Block = () => {
    return (
        <div className='gpt3__block section__padding'>
            <div className="gpt3__block-heading">
                <h1 className='gradient__text'>A lot is happening, We are blogging about it.</h1>
            </div>
            <div className="gpt3__block-container">
                <div className="gpt3__block-container_groupA">
            <Article imgUrl={blog01} date='Sep 26, 2021' title='GPT-3 and Open  AI is the future. Let us exlore how it is?'/>
                </div>
                <div className="gpt3__block-container_groupB">
